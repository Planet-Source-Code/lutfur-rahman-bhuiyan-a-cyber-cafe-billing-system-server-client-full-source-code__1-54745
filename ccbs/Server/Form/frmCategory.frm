...
Private Sub Form_Load()
  ...
  adoPrimaryRS.Open "select [category ID],[Category Name] from Category", db, adOpenStatic, adLockOptimistic
...
If adoPrimaryRS.Fields(0) > catid And IsNumeric(adoPrimaryRS.Fields(0)) Then
...
End If
Do Until adoPrimaryRS.EOF
If adoPrimaryRS.Fields(0) = l.SelectedItem.Text Then
Exit Sub
End If
adoPrimaryRS.MoveNext
Loop
