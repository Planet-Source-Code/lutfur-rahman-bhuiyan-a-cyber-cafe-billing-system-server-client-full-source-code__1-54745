...
Begin VB.Form frmReceipt1 
   ...
   Begin VB.PictureBox Picture1 
      ...
      Begin Project1.xpButton xpButton1 
         ...
         tx              =   "&Save"
         enab            =   -1  'True
         font            =   "frmReceipt1.frx":0000
         focusr          =   -1  'True
         mptr            =   0
         micon           =   "frmReceipt1.frx":002C
      End
      Begin Project1.xpButton xpButton2 
         ...
         tx              =   "&Print"
         enab            =   0   'False
         font            =   "frmReceipt1.frx":004A
         focusr          =   -1  'True
         mptr            =   0
         micon           =   "frmReceipt1.frx":0076
      End
      Begin Project1.xpButton xpButton3 
         ...
         tx              =   "E&xit"
         enab            =   -1  'True
         font            =   "frmReceipt1.frx":0094
         focusr          =   -1  'True
         mptr            =   0
         micon           =   "frmReceipt1.frx":00C0
      End
   End
   Begin VB.TextBox txtFields 
      Alignment       =   1  'Right Justify
...
txtFields(4).Text = Format(Date, "dd/mm/yyyy")
End Sub
