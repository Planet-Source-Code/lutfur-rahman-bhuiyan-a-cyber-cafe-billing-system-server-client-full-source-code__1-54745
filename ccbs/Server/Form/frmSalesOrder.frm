...
Begin VB.Form frmSalesOrder 
   ...
   Begin VB.PictureBox picStatBox 
      ...
      Begin VB.CommandButton cmdLast 
         Height          =   300
         Left            =   4545
         Picture         =   "frmSalesOrder.frx":0000
         Style           =   1  'Graphical
         TabIndex        =   18
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdNext 
         Height          =   300
         Left            =   4200
         Picture         =   "frmSalesOrder.frx":0342
         Style           =   1  'Graphical
         TabIndex        =   17
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdPrevious 
         Height          =   300
         Left            =   345
         Picture         =   "frmSalesOrder.frx":0684
         Style           =   1  'Graphical
         TabIndex        =   16
         Top             =   0
         UseMaskColor    =   -1  'True
      ...
      Begin VB.CommandButton cmdFirst 
         Height          =   300
         Left            =   0
         Picture         =   "frmSalesOrder.frx":09C6
         Style           =   1  'Graphical
         TabIndex        =   15
         Top             =   0
         UseMaskColor    =   -1  'True
...
.Fields("doc") = txtDoc
.Fields("Vendor name") = txtFields(5).Text
.Fields("date") = txtFields(3).Text
.Update
End With
...
For i = 1 To l.ListItems.Count
l.ListItems(i).Selected = True
tot = tot + Val(l.SelectedItem.SubItems(5))
Next
End If
Text1.Text = tot
