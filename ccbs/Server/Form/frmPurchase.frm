...
If adoPrimaryRS2.Fields(0) = txtFields(4) Then
found = True
txtFields(5) = adoPrimaryRS2.Fields(1)
End If
...
adoPrimaryRS.Open "select * from Purchase", db, adOpenStatic, adLockOptimistic
...
adoPrimaryRS2.Open "select id,name,address,email,phone from vendor", db, adOpenStatic, adLockOptimistic
  
Set adoPrimaryRS3 = New Recordset
adoPrimaryRS3.Open "select * from [Voucher No]", db, adOpenStatic, adLockOptimistic
...
Set adoPrimaryRS = New Recordset
adoPrimaryRS.Open "select * from Purchase where doc='" & txtDoc.Text & "'", db, adOpenStatic, adLockOptimistic
...
db.Execute "Delete from Purchase where doc='" & txtDoc.Text & "'"
...
l.ListItems(i).Selected = True
adoPrimaryRS.AddNew
adoPrimaryRS.Fields(0) = l.SelectedItem.Text
adoPrimaryRS.Fields(1) = l.SelectedItem.SubItems(1)
adoPrimaryRS.Fields(2) = l.SelectedItem.SubItems(2)
adoPrimaryRS.Fields(3) = l.SelectedItem.SubItems(3)
adoPrimaryRS.Fields(4) = txtFields(4).Text
adoPrimaryRS.Fields(5) = txtFields(5).Text
adoPrimaryRS.Fields(6) = l.SelectedItem.SubItems(4)
adoPrimaryRS.Fields(7) = l.SelectedItem.SubItems(5)
adoPrimaryRS.Fields(8) = txtFields(2).Text
adoPrimaryRS.Fields(9) = txtFields(3).Text
adoPrimaryRS.Fields("doc") = txtDoc
adoPrimaryRS.Update
Next

With adoPrimaryRS3
.AddNew
.Fields("voucher no") = txtFields(2).Text
.Fields("flag") = 0
.Fields("vendor id") = txtFields(4).Text
.Fields("doc") = txtDoc
.Update
End With
