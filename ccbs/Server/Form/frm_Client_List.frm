...
Begin VB.Form frm_Client_List 
   ...
   End
End
Attribute VB_Name = "frm_Client_List"
...
frm_remote_login.txtFields(0).Text = l.SelectedItem.Text
frm_remote_login.txtFields(1).Text = l.SelectedItem.SubItems(1)
frm_remote_login.txtFields(2).Text = l.SelectedItem.SubItems(3)
Unload Me
End Sub
